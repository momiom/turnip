<template>
  <modal-wrapper :showing="showDeleteConfirm" @close="$emit('close')">
    <div class="w-10/12 max-w-md modal">
      <svg
        width="168"
        height="67"
        viewBox="0 0 168 67"
      ...
      <div class="grid grid-cols-2 gap-2 p-4 md:max-w-xs">
        <div class="col-span-2">
          <p class="text-center text-main-brown text-base">
            カブ価の入力をやりなおしますか？
          </p>
        </div>
        ...
        <div class="col-span-1 p-2">
          <button
            class="w-full h-full bg-money-blue hover:bg-money-blue-dark rounded-full py-1 text-center text-white text-base focus:outline-none"
            @click="clearPrices"
          >
            はい
          </button>
